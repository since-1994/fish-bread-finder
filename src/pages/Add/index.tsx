...
const Add: React.FC = () => {
    ...
    //   const {lat, lon} = await getCurrentPosition();
      const resetPosition = new window.kakao.maps.LatLng( 37.57002838826, 126.97962084516);
    ...
    function handleAddButonClick(e:React.MouseEvent): void{
        ...
        alert(`한경 ! 이 위치 정보를 가져다 써!-> lat:${lat}, lon:${lng}`)
    }
    ...
    return (
        <div>
            ...
            <button type="button" onClick={handleAddButonClick} className={styles['add-button']}>
                이 곳에 추가할래요!
            </button>
            {/* <Layer>
            </Layer> */}
